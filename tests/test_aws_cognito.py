...
from mlopspropmgmt.auth.cognito import CognitoAuth, get_auth_manager
...
def test_cognito_auth_login_url():
    ...
    with patch.object(settings, "cognito_user_pool_id", "us-east-1_testing"), \
         patch.object(settings, "cognito_client_id", "test-client-id"), \
...
def test_cognito_token_validation(aws_credentials):
    ...
    with mock_aws():
        ...
        with patch('jwt.decode') as mock_decode, \
             ...
             patch('mlopspropmgmt.auth.cognito.CognitoAuth.get_jwks') as mock_get_jwks:
